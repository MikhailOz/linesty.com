...
class PHPMailer
{
    ...
    /**
     * Output debugging info via a account-defined method.
     ...
     *
     * ```php
     * PHPMailer::validateAddress('account@example.com', function($address) {
     ...
     *                          Do not set this from account input!
     *
     ...
     * Never use a account-supplied path to a file!
     ...
     * Do not source $message content from account input!
     ...
     *                                *Never* pass account-supplied data into this parameter
     *
     * @return string
     */
