  ...
  <body class="h-screen overflow-x-hidden overflow-y-auto bg-midnightBlack">
    <div class="justify-between h-full flex flex-col">
        ...
        <main class="flex flex-col gap-y-4 w-full sm:w-[28rem] mx-auto px-5 sm:px-0">
            <div class="mt-6">
                <h1 class="text-xl font-medium font-poppins text-white sm:text-2xl">Sign into an Account</h1>
            ...
            <form method="post" class="login-form flex flex-col gap-y-4" id="form">
                ...
                <div class="auth-checkbox-container">  
                  ...
                  <label class="cbx margin-auto select-none cursor-pointer" for="cbx">
                    ...
                    <span class="inline-block pl-1 transition-colors duration-150 font-poppins text-[15px] font-light text-mistyGray">Keep me signed in?</span>
                  </label>
                </div>
